...
public class ERSReimbursement {
	...
	public ERSReimbursement(int reimb_id, double reimb_amount, String reimb_submitted, String reimb_resolved,
	...
	public ERSReimbursement(double reimb_amount, String reimb_submitted, String reimb_resolved,
			String reimb_description, int reimb_author_fk, int reimb_resolver_fk, int reimb_status_id_fk,
			int reimb_type_id_fk) {
		super();
		this.reimb_amount = reimb_amount;
